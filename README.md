...
|           | f = 100 | f = 400 | f = 3000 |
| --------- | ------- | ------- | -------- |
| fs = 4000 | 0.9528 | 0.6231 | inf |
| fs = 8000 | 0.9613 | 0.6589 | 0.1467 |
| fs = 16000 | 0.9657 | 0.6812 | 0.1303 |
...
|           | f = 100 | f = 400 | f = 3000 |
| --------- | ------- | ------- | -------- |
| fs = 4000 | -0.00037 | -0.000246 | 0.000163 |
| fs = 8000 | -0.000328 | -0.000279 | -0.000018 |
| fs = 16000 | -0.000385 | -0.000295 | -0.000046 |

---

當 f 相同時：
 - fs 越高，波形越完整
 - fs 越高，模擬出的振幅與理論值的誤差越小
 - fs 越高，模擬出的phase delay與理論值的誤差越小
